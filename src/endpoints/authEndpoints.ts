...
import type { AuthResponse, ChangePassword, LoginRequest, RegisterRequest } from "@/types/auth";
...
export const authApi = {
    ...
    async changePassword(passwordRequest: ChangePassword): Promise<ServiceResponse<boolean>> {
        const response = await api.post<ServiceResponse<boolean>>("/api/Auth/change-password", passwordRequest);
        return response.data;
    }
}