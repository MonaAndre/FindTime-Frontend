  ...
  <section>
    ...
    <div v-if="groupStore.categories.length > 0" class="space-y-3">
      <div
        ...
        class="flex items-center justify-between py-2 px-2 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow dark:bg-zinc-800 dark:border-gray-600"
      >
        <div class="flex items-center gap-3">
          ...
          ></span>
          <span class="font-medium text-sm text-gray-900 dark:text-zinc-200">{{ category.categoryName }}</span>
        </div>
